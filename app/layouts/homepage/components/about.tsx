      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="flex justify-center gap-48 items-center flex-col">
          <div className="flex flex-col md:flex-row gap-24 items-center">
            <Image src='/images/about-pic.png' width={600} height={300} alt="Self Shooting" className="rounded-[20px]"/>
            <div>
          ...
          <div className="flex flex-col md:flex-row-reverse gap-24 items-center">
            <Image src='/images/self-shoot.png' width={600} height={300} alt="Shooting" className="rounded-[20px]"/>
            <div>
              <p className="text-[32px] align-middle font-semibold">
