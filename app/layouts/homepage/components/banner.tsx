...
const Banner: React.FC<BannerProps> = ({ text, img, video }) => {
    ...
    { video ? 
        ...
        >
          <div className="relative w-full h-full">
            ...
            {text && <p className="absolute inset-0 flex justify-center items-center uppercase text-7xl sm:text-2xl md:text-4xl text-white">{text}</p>}
          </div>
        </div>
        :  
        <div
